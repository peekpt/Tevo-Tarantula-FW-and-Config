 ...
 */
#define E0_STEPS 417        // Stock extruder. If you have a Tevo Titan, try 400 then calibrate.
...
#define HOTEND_OFFSET_Z \
  {                     \
    0.0, EXTRUDER_E1_Z  \
  } // (mm) relative Z-offset for each nozzle
#endif
...
#define NOZZLE_TO_PROBE_OFFSET                                  \
  {                                                             \
    SENSOR_RIGHT - SENSOR_LEFT, SENSOR_BEHIND - SENSOR_FRONT, 0 \
  }
